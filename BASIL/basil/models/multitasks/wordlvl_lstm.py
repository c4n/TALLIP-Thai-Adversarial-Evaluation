...
class LSTMTagger(nn.Module):
    ...
    def __init__(self, word_embedding_dim, hidden_dim, char_size, word_size, tagset_size_pos, tagset_size_ner):
        ...
        self.lstm_pos_ner = nn.LSTM(word_embedding_dim, hidden_dim // 2, bidirectional = True)
...
#         print(word_char_cat.shape,word_char_cat.view(len(word_char_cat), 1, -1).shape)
    ...
    def forward(self, text_word_seq):
        ...
        lstm_pos_feats, lstm_ner_feats = self._lstm_pos_ner_feats(word_emb)
