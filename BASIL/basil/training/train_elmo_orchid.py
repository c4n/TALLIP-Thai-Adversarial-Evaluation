...
#                     continue
        ...
        #             logger.scalar_summary(tag, value, count)
            ...
            print("F1 (POS):",f1_pos)
            if f1_pos > best_f1:
                torch.save(self.model.state_dict(), "weights/model_BILSTM_elmo_ORCHID_seed"+str(self.seed_num)+".p")#save best model only
                best_f1 = f1_pos


if __name__ == '__main__':
    orchid  = ORCHID()
    trainer = TrainModel(ORCHIDTagger, orchid)
    trainer.train(40)
