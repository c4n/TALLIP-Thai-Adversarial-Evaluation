...
from basil.models.multitasks.backoff_lstm_affix_rnn_init import LSTMTagger
...
class TrainModel:
    ...
    def train(self, epoch_num:int):
        ...
        for epoch in range(epoch_num):
            input_text = self.prep_torch.input_train_word[:497]
        ...
        #             logger.scalar_summary(tag, value, count)
            ...
            if f1_pos+f1_ner > best_f1:
                torch.save(self.model.state_dict(), "model_affix_init_unk10_small.p")#save best model only
