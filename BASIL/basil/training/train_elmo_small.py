...
class TrainModel:
    ...
    def train(self, epoch_num:int):
        ...
        #         input_text = input_train_word
            input_text = self.prep_torch.input_train_word#adjust number of training samples here
        ...
        #             logger.scalar_summary(tag, value, count)
            ...
            if f1_pos+f1_ner > best_f1:
                torch.save(self.model.state_dict(), "weights/model_elmo_pretrained_small_seed"+str(self.seed_num)+".p")#save best model only
